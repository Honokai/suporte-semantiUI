...
@section('conteudo')
    ...
    <div style="display:flex; flex-direction: row; padding: 10px">
        <div class="ui medium image" style="flex:1; padding: 10px 7px 5px 7px; background-color: rgb(63, 116, 230); border-radius: 10px; margin: 0px 5px 0px 5px">
            <div class="modal-header">
                ...
                <div>
                    ...
                    <div class="ui fluid search selection dropdown">
                        ...
                        <div class="menu">
                            ...
                            @foreach($categorias->whereNotIn('id', $chamado->subcategoria->id) as $categoria)
                ...
                @if($chamado->transferencias()->get()->first())
                    ...
                    <div class="ui item">
                        {{$chamado->subcategoria->categoria->setor->nome}} ->
        ...
        <div style="flex:3">
            ...
            <div class="scrolling image content" style="max-height: 280px; overflow: hidden">
    ...
    <script>
        $('.ui.selection.dropdown').dropdown({'set selected': '{{$chamado->subcategoria->categoria->setor->nome}} - {{$chamado->subcategoria->categoria->nome}}'});
    </script>
@endsection